...
function do_mv(){
  git submodule deinit resources/$1
  git rm -f --cached resources/$1
  mv resources/$1 resources/$2
  git init resources/$2
  git commit -am "mv a submodule from resources/$1 to resources/$2 "
  git push
}
